...
int main(int argc,char *argv[]){
    ...
    for(int i=0;i<=m+1;i++)  for(int j=0 ; j<=n+1 ; j++)  visited[i][j] = false;
    cur_x = start_x;
    cur_y = start_y;
    ...
    while(dist[wow_x][wow_y]!=0){
        Path.emplace_back(wow_x-1);
        Path.emplace_back(wow_y-1);
        if(dist[wow_x-1][wow_y]==dist[wow_x][wow_y]-1) {wow_x=wow_x-1; wow_y=wow_y;}
        else if(dist[wow_x+1][wow_y]==dist[wow_x][wow_y]-1) {wow_x=wow_x+1; wow_y=wow_y;}
        else if(dist[wow_x][wow_y+1]==dist[wow_x][wow_y]-1) {wow_x=wow_x; wow_y=wow_y+1;}
        else if(dist[wow_x][wow_y-1]==dist[wow_x][wow_y]-1) {wow_x=wow_x; wow_y=wow_y-1;}
    }
